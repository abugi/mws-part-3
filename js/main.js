...
/**
 * TODO: Fetch neighborhoods and cuisines as soon as the page is loaded.
 */
...
/**
 * TODO: Fetch all neighborhoods and set their HTML.
 */
fetchNeighborhoods = () => {
...
//TODO: add a show map button
addShowMapButton = () => {
  const container =  document.querySelector('.map-container');
  const button = document.createElement('button');
  button.setAttribute('class', 'show-map');
  button.innerHTML = 'Reveal Map';
...
//TODO: Initialize leaflet map, called from HTML.
initMap = () => {
